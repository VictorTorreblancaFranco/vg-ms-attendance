...
import com.vg.task.web.handler.TaskSubmissionHandler;
...
@Configuration
public class TaskSubmissionRouter {

    private static final String API_V1 = "/api/v1/task/submissions";

    @Bean
    public RouterFunction<ServerResponse> taskSubmissionRoutes(TaskSubmissionHandler handler) {
        return route(GET(API_V1), handler::findAll)
                ...
                .andRoute(POST(API_V1 + "/task/{taskId}/submit"), handler::submit)
